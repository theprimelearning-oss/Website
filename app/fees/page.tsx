                ...
                {courses.map((course, idx) => (
                  <tr key={course.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-slate-50/50'}>
                    ...
                    <td className="p-4 font-semibold">
                      {course.grade.includes('1 - 5') || course.grade.includes('Primary')
                        ? 'Rashmi Anand'
                        : course.subject.includes('Maths & Science') || course.subject.includes('Combined')
                        ? 'Praveen Gandhi & Rashmi Anand'
                        : course.subject.includes('Math')
                        ? 'Praveen Gandhi'
                        : 'Rashmi Anand'}
                    </td>
